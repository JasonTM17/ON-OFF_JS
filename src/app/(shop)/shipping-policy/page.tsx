          ...
          <section>
            ...
            <div className="space-y-3 text-sm text-muted leading-relaxed">
              <div className="flex items-start gap-2">
                ...
                <p><strong className="text-foreground">Miễn phí ship</strong> cho đơn hàng từ 500.000₫</p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-foreground mt-0.5">•</span>
                <p>Đơn hàng dưới 500.000₫: phí ship <strong className="text-foreground">30.000₫</strong> (toàn quốc)</p>
              </div>
              <div className="flex items-start gap-2">
                <span className="text-foreground mt-0.5">•</span>
